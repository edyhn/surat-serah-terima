...
async function tambahRiwayat(s) {
  return seri(async () => {
    ...
    ws.addRow([no, s.nomor, s.tanggal, s.tanggalSingkat, s.kategori, s.nama, s.departemen, s.penerima, s.departemenPenerima, s.keterangan, s.namaHrd || '']);
    beriStyle(ws);
...
async function bikinExcel(daftar) {
  ...
  urut.forEach((s, i) => {
    ws.addRow([i + 1, s.nomor, s.tanggal, s.tanggalSingkat, s.kategori, s.nama, s.departemen, s.penerima, s.departemenPenerima, s.keterangan, s.namaHrd || '']);
  });
  beriStyle(ws);
